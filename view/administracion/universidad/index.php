		...
		<div class="col-xs-12">
	  		<div class="box">
	    		<div class='box-header with-border'>
	      			...
	      			<a class="btn btn-sm btn-primary pull-right" href="?c=Universidad&a=v_Registrar"> Nuevo Universidad</a>
	    		</div>
	                    	...
	                    	<tr>
                            	...
                            	<td class="a_center">                            		
                            		<a href="?c=Universidad&a=v_Actualizar&idUniversidad=<?php echo $universidad['idUniversidad']; ?>" class="btn btn-primary btn-xs " data-toggle="tooltip" data-placement="top" title="Actualizar">
                               		...
                               		<a class="btn btn-danger btn-xs EliminarUniversidad" data-id="<?php echo $universidad['idUniversidad']; ?>" data-universidad="<?php echo $universidad['codigo'].' '.$universidad['nombre']; ?>" data-toggle="tooltip" data-placement="top" title="Eliminar">
