		...
		<div class="col-xs-12">
	  		<div class="box">
	    		<div class='box-header with-border'>
	      			<h3 class='box-title'><i class="fa fa-briefcase"></i> Lista de Curos</h3> 
	                    	...
	                    	<tr>
                            	...
                            	<td class="a_center">                            		
                            		<a href="?c=Curso&a=v_Actualizar&idCurso=<?php echo $curso['idCurso']; ?>" class="btn btn-primary btn-xs " data-toggle="tooltip" data-placement="top" title="Actualizar">
                               		...
                               		<a class="btn btn-danger btn-xs EliminarCurso" data-id="<?php echo $curso['idCurso']; ?>" data-curso="<?php echo $curso['nombre'].' '.$curso['profesor']; ?>" data-toggle="tooltip" data-placement="top" title="Eliminar">
