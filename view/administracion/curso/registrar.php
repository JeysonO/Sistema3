	  		...
	  		<div class="box">
	    		...
	    		<div class="box-body">
	    			<form id="frmRegistrarCurso"  action="?c=Curso&a=Registrar" method="post" enctype="multipart/form-data" role="form">	   				
					    ...
					    <div class="form-group col-md-4 formulario__grupo formulario__grupo-correcto" id="grupo__primer_nombre" >
					    ...
					    <div class="form-group col-md-8">
					        <label for="profesor" class="formulario__label">Profesor</label>
