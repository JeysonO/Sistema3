	                    	...
	                    	<tr>
                            	...
                            	<td class="a_center">                            		
                            		<a href="?c=Alumno&a=v_Actualizar&idAlumno=<?php echo $alumno['idAlumno']; ?>" class="btn btn-primary btn-xs " data-toggle="tooltip" data-placement="top" title="Actualizar">
                               		...
                               		<a class="btn btn-danger btn-xs EliminarAlumno" data-id="<?php echo $alumno['idAlumno']; ?>" data-alumno="<?php echo $alumno['primer_nombre'].' '.$alumno['apellido_paterno'].' '.$alumno['apellido_materno'].' '.$alumno['dni']; ?>" data-toggle="tooltip" data-placement="top" title="Eliminar">
