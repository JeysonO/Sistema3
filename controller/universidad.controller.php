...
class UniversidadController extends IncludesController{    
    ...
    {
        $universidades = $this->model->ListarUniversidadesTI();
        return $universidades;
    }
    ...
    public function Actualizar(){
        ...
        $universidad->__SET('direccion',$_SESSION['direccion']);      
        $universidad->__SET('licenciado',$_SESSION['licenciado']);      
        $universidad->__SET('cantidad_carreras',$_SESSION['cantidad_carreras']);      
        $universidad->__SET('modificado_por',$_SESSION['Usuario_Actual']);      
        $universidad->__SET('activo',$_REQUEST['activo']);                  
        $universidad->__SET('eliminado',$_REQUEST['eliminado']);                  
